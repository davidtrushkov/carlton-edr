<x-app-layout>
    <div class="container mx-auto pt-12 pb-6 pl-2 pr-2">
        <form action="/wells/update/{{ $well->id }}" method="post">
        @csrf
            ...
            <div class="lg:flex lg:justify-between mb-12">
                <div class="lg:flex-1 bg-white rounded-lg p-4">
                    ...
                    <div class="text-xl font-black mb-12">
                        Editing Well {{ $well->well_id }} <hr />
                    </div>
                    ...
                    <div class="grid md:grid-cols-4 sm:grid-cols-2 gap-4 pb-12">
                        <div>
                            <label class="block">
                                ...
                                <select name="well_id" class="@if($errors->has('well_id'))border-red-500 @endif block bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                    ...
                                    <option value="21" {{ $well->well_id == 21 ? 'selected' : '' }}>21</option>
                                    <option value="22" {{ $well->well_id == 22 ? 'selected' : '' }}>22</option>
                                    <option value="23" {{ $well->well_id == 23 ? 'selected' : '' }}>23</option>
                                    <option value="24" {{ $well->well_id == 24 ? 'selected' : '' }}>24</option>
                                    <option value="25" {{ $well->well_id == 25 ? 'selected' : '' }}>25</option>
                                    <option value="26" {{ $well->well_id == 26 ? 'selected' : '' }}>26</option>
                                    <option value="27" {{ $well->well_id == 27 ? 'selected' : '' }}>27</option>
                                    <option value="29" {{ $well->well_id == 29 ? 'selected' : '' }}>29</option>
                                    <option value="30" {{ $well->well_id == 30 ? 'selected' : '' }}>30</option>
                                    <option value="31" {{ $well->well_id == 31 ? 'selected' : '' }}>31</option>
                                    <option value="32" {{ $well->well_id == 32 ? 'selected' : '' }}>32</option>
                                    <option value="33" {{ $well->well_id == 33 ? 'selected' : '' }}>33</option>
                                    <option value="38" {{ $well->well_id == 38 ? 'selected' : '' }}>38</option>
                                    <option value="39" {{ $well->well_id == 39 ? 'selected' : '' }}>39</option>
                                    <option value="59" {{ $well->well_id == 59 ? 'selected' : '' }}>59</option>
                                    <option value="60" {{ $well->well_id == 60 ? 'selected' : '' }}>60</option>
                                </select>
                            </label>
                        ...
                        <div>
                            <label class="block">
                                ...
                                <input type="date" name="date" value="{{ date('Y-m-d', strtotime($well->date)) }}" class="@if($errors->has('date'))border-red-500 @endif p-2 mt-1 block w-full rounded-md border-2 border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                            </label>
                            @if ($errors->has('date'))
                        ...
                        <div class="grid md:grid-cols-8 sm:grid-cols-4 gap-4">
                            ...
                            <div>
                                <label class="block">
                                    ...
                                    <input type="text" value="{{ $well->temp }}"
                            ...
                            <div>
                                <label class="block">
                                    ...
                                    <input type="text" value="{{ $well->cond }}"
                            ...
                            <div>
                                <label class="block">
                                    ...
                                    <input type="text" value="{{ $well->ntu }}"
                            ...
                            <div>
                                <label class="block">
                                    ...
                                    <input type="time" value="{{ $well->grab_time }}"
