<x-app-layout>
    <div class="container mx-auto pt-12 pb-8 pl-2 pr-2">
        <form action="/edrs/update/{{ $edr->id }}" method="post">
        @csrf
            <div class="lg:flex lg:justify-between mb-12">
                                    ...
                                    <table class="min-w-max w-full table-auto">
                                        ...
                                        <tbody class="text-gray-600 text-sm font-light">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                    <label class="block">
                                                        <select name="edr_id" class="@if($errors->has('edr_id'))border-red-500 @endif block bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                                            ...
                                                            <option value="2" {{ $edr->edr_id == 2 ? 'selected' : '' }}>2</option>
                                                            <option value="4" {{ $edr->edr_id == 4 ? 'selected' : '' }}>4</option>
                                                            <option value="6" {{ $edr->edr_id == 6 ? 'selected' : '' }}>6</option>
                                                            <option value="8" {{ $edr->edr_id == 8 ? 'selected' : '' }}>8</option>
                                                            <option value="10" {{ $edr->edr_id == 10 ? 'selected' : '' }}>10</option>
                                                        </select>
                                                    </label>
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                    <label class="block">
                                                        <input type="date" name="date" value="{{ old('date') ? old('date') : date('Y-m-d', strtotime($edr->date)) }}" class="@if($errors->has('date'))border-red-500 @endif p-2 mt-1 block w-full rounded-md border-2 border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                                                    </label>
                                                    @if ($errors->has('date'))
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                    <label class="block">
                                                        <select name="polarity" class="@if($errors->has('polarity'))border-red-500 @endif block bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                                            ...
                                                            <option value="neg" {{ $edr->polarity == 'neg' ? 'selected' : '' }}>Negative</option>
                                                            <option value="pos" {{ $edr->polarity == 'pos' ? 'selected' : '' }}>Positive</option>
                                                        </select>
                                                    </label>
                                                    @if ($errors->has('polarity'))
                                                        <div class="text-red-500 text-sm font-bold">{{ $errors->first('polarity') }}</div>
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('run_hours') ? old('run_hours') : $edr->run_hours }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('feed_cl2') ? old('feed_cl2') : $edr->feed_cl2 }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('feed_ph') ? old('feed_ph') : $edr->feed_ph }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('feed_temp') ? old('feed_temp') : $edr->feed_temp }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('feed_cond') ? old('feed_cond') : $edr->feed_cond }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('product_cond') ? old('product_cond') : $edr->product_cond }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('concen_cond') ? old('concen_cond') : $edr->concen_cond }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('electrode_inlet_ph') ? old('electrode_inlet_ph') : $edr->electrode_inlet_ph }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('post_cart_psi') ? old('post_cart_psi') : $edr->post_cart_psi }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('stack_inlet_psi') ? old('stack_inlet_psi') : $edr->stack_inlet_psi }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('inlet_press_dif') ? old('inlet_press_dif') : $edr->inlet_press_dif }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('outlet_press_dif') ? old('outlet_press_dif') : $edr->outlet_press_dif }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('dil_stack_outlet_psi') ? old('dil_stack_outlet_psi') : $edr->dil_stack_outlet_psi }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('conc_stack_inlet_psi') ? old('conc_stack_inlet_psi') : $edr->conc_stack_inlet_psi }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('feed_inlet_flow') ? old('feed_inlet_flow') : $edr->feed_inlet_flow }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('dil_outlet_flow') ? old('dil_outlet_flow') : $edr->dil_outlet_flow }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('cbd_flow') ? old('cbd_flow') : $edr->cbd_flow }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('conc_pump_kw') ? old('conc_pump_kw') : $edr->conc_pump_kw }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('conc_pump_speed') ? old('conc_pump_speed') : $edr->conc_pump_speed }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('feed_valve_pos') ? old('feed_valve_pos') : $edr->feed_valve_pos }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('electrode_dosage') ? old('electrode_dosage') : $edr->electrode_dosage }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('antiscalant_dosage') ? old('antiscalant_dosage') : $edr->antiscalant_dosage }}"
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-left whitespace-nowrap">
                                                <label class="block">
                                                    <input type="text" value="{{ old('osp_time') ? old('osp_time') : $edr->osp_time }}"
             ...
             <div class="text-left py-2 pt-16 px-3 -mx-3 -mb-2 rounded-b-lg">
                ...
                <input type="submit" name="save" value="Update" class="bg-teal-500 focus:outline-none focus:bg-teal-600 focus:border-gray-500 hover:bg-teal-400 border-teal-600 text-white font-bold py-3 px-6 rounded leading-tight">
            </div>
